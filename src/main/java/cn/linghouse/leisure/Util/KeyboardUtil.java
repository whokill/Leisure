...
public class KeyboardUtil {
    ...
    public KeyboardUtil(Context context,Dialog dialog){
        this.dialog = dialog;
        this.context = context;
        mKeyboardView = dialog.findViewById(R.id.keyboard_view);
        mKeyboardNumber = new Keyboard(context,R.xml.keyboardnumber);
    }
